        ...
        <div className="user-page">
            <div className="controls">
                ...
                <form className="filters">
                    ...
                    <input type="text" id="tags" name="tags" ref={tagsRef} onChange={handleChange}/>
                    <label htmlFor="file">File:</label>
                    <input type="text" id="file" name="file" ref={fileRef} onChange={handleChange}/>
                </form>
            </div>
            <div className="content">
                <FileViewer files = {files} filters = {filters} controller = {setSelectedFile}/>
